...
export function validateOrder(
  ...
  if (body.orderType === "SL" && price != null && triggerPrice != null) {
...
export function parseKiteOrderError(error: unknown): string {
  ...
  return "Order could not be placed due to a technical issue. Please try again.";
}
